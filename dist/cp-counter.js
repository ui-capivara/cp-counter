...
/*!*********************************************!*\
  !*** ../src/component/counter.component.ts ***!
  \*********************************************/
/*! exports provided: CapivaraCounter */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CapivaraCounter", function() { return CapivaraCounter; });
var CapivaraCounter = /** @class */ (function () {
    function CapivaraCounter($scope, $element) {
        this.$scope = $scope;
        this.$element = $element;
    }
    CapivaraCounter.prototype.$onInit = function () {
        if (!this.$constants.maxLength) {
            throw new Error('max-length é um parâmetro obrigatório.');
        }
    };
    CapivaraCounter.prototype.$onViewInit = function () {
        var _this = this;
        setTimeout(function () {
            _this.$bindings.cpModel = (_this.$bindings.cpModel || '').substring(0, _this.$constants.maxLength);
        });
    };
    CapivaraCounter.prototype.getRemainingCaracteres = function () {
        return this.$constants.maxLength - (this.$bindings.cpModel || '').length;
    };
    return CapivaraCounter;
}());
...
/***/ "../src/component/counter.style.scss":
/*!*******************************************!*\
  !*** ../src/component/counter.style.scss ***!
  \*******************************************/
/*! no static exports found */
...
/***/ "../src/component/counter.template.html":
/*!**********************************************!*\
  !*** ../src/component/counter.template.html ***!
  \**********************************************/
/*! no static exports found */
...
module.exports = "<div class=\"cp-counter-wrapper\">\n  <input type=\"text\"\n         cp-attr.maxlength=\"$ctrl.$constants.maxLength\"\n         cp-model=\"$ctrl.$bindings.cpModel\"\n         class=\"form-control\"\n         cp-attr.placeholder=\"$ctrl.$constants.placeholder\">\n  <p cp-if=\"$ctrl.getRemainingCaracteres() > 0\">\n    [[ $ctrl.getRemainingCaracteres() ]] caracteres restantes.\n  </p>\n  <p cp-else>\n    Você atingiu o limite de [[ $ctrl.$constants.maxLength ]] caracteres.\n  </p>\n</div>\n";
...
/* harmony import */ var _component_counter_template_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./component/counter.template.html */ "../src/component/counter.template.html");
/* harmony import */ var _component_counter_template_html__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_component_counter_template_html__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _component_counter_style_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./component/counter.style.scss */ "../src/component/counter.style.scss");
/* harmony import */ var _component_counter_style_scss__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_component_counter_style_scss__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _component_counter_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./component/counter.component */ "../src/component/counter.component.ts");
/*
...
var Component = {
     ...
     */
    template: _component_counter_template_html__WEBPACK_IMPORTED_MODULE_1___default.a,
    /**
     * @name style
     * @description Import component style
     */
    style: _component_counter_style_scss__WEBPACK_IMPORTED_MODULE_2___default.a,
    /**
     * @name constants
     ...
     */
    controller: _component_counter_component__WEBPACK_IMPORTED_MODULE_3__["CapivaraCounter"]
};
/* harmony default export */ __webpack_exports__["default"] = (capivarajs__WEBPACK_IMPORTED_MODULE_0___default.a.component('cp-counter', Component));


/***/ })

/******/ });
//# sourceMappingURL=cp-counter.js.map